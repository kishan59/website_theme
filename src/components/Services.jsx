...
import { PhotoChatMessage, Gradient, 
    VideoBar, VideoChatMessage } from './design/Services'
                ...
                <div className='relative z-1 flex items-center 
                    ...
                    <div className='absolute top-0 left-0 w-full
                        ...
                        <img className='w-full h-full object-cover md:object-right' 
                            src={service1} width={800} height={730} alt='Smartest AI'
                        />
                    </div>
                    ...
                    <div className='relative min-h-[39rem] 
                        ...
                        <div className='absolute inset-0'>
                            <img className='w-full h-full object-cover'
                                src={service2} width={630} height={750} alt='robot'
                            />
                        </div>
                        ...
                        <div className='py-12 px-4 xl:px-8'>
                            ...
                            <ul className='flex items-center justify-between'>
                                {brainwaveServicesIcons.map((item, index) => (
                                    ...
                                    >
                                        <div className={index === 2 ? `flex items-center 
                                            justify-center w-full h-full bg-n-7 rounded-2xl` : ''}
                                        >
